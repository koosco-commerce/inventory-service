...
# Inventory Service 로컬 빌드 & 테스트 스크립트
# 사용법: ./test-local.sh
...
echo -e "${GREEN}========================================${NC}"
echo -e "${GREEN}Inventory Service Local Build & Test${NC}"
echo -e "${GREEN}========================================${NC}"
echo ""
...
echo -e "${GREEN}[4/6]${NC} Starting inventory-service container..."
